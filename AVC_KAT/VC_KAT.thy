section {* Verification Component Based on KAT *}

theory VC_KAT
imports "../P2S2R"
        "$AFP/KAT_and_DRA/SingleSorted/PHL_KAT" 
        "$AFP/KAT_and_DRA/SingleSorted/KAT_Models"
...
subsection {* Definitions of Hoare Triple *}
...
subsection {* Syntax for Conditionals and Loops *}
...
subsection {* Inference Rules of Propositional Hoare Logic *}
...
subsection {* Simplified Hoare Rules *}
